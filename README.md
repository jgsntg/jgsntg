...
Product executive building at the intersection of **payments, AI, and platforms** — currently at JPMorgan Chase, previously Apple, Meta, and Microsoft.

This profile is where I prototype with **agentic tooling** outside of work. I'm a builder at heart, and I think product leaders working on AI products need to stay close to the materials — so I do. Every project here started as a personal pain point I wanted to solve with the AI stack of the moment.

---

### 🛠️ What I'm Building

A small portfolio of personal AI products, each scratching a real itch in my own life:
...
I lead AI-enabled pricing and billing platforms at JPMorgan Chase that process $60MM+ annually across 6K+ global users and 12K+ pricing models per month. Recently led the org-wide rollout of AI agents into the product development lifecycle — taking requirements creation speed up 300% and defect efficiency up 200%.

Before JPMC: shipped commerce platforms at Apple (1.5B+ users), Marketplace cart/PDP at Meta (1B+ users, +11% conversion), and Windows servicing at Microsoft (2B+ in-market devices).

---

### 🧠 What I Care About

- **Agentic tooling** — both consumer-facing and as an internal force multiplier
- **Payments & commerce platforms** — especially the fraud, risk, and trust layer
- **Regulated environments** — where the constraints make the product better, not worse
- **Compressing decision cycles** — turning weeks into hours with the right tooling
- **Building to learn** — the fastest way to understand a new AI capability is to ship something with it

---

### 🤝 Let's Connect

- 💼 [LinkedIn](https://linkedin.com/in/jgsantiago)
- ✉️ jg.sntg@outlook.com
